        ...
        <div className='bg-gradient-to-r from-red-600 to-red-400 h-60'>
            <div className='p-5'>
                <h2 className='text-4xl text-white text-center font-bold'>
                    Over 157,000 hotels and homes across countries
                </h2>
                ...
                <div className="flex mx-20 my-5 font-bold">
                    ...
                    <button
                        type="submit"
                        className='h-16 px-3 py-2  hover:cursor-pointer border-2 border-white text-white text-xl mr-5 hover:bg-slate-500 rounded-xl'>
